...
void ClockPanel::Create(lv_obj_t* parent, lv_color_t backgroundColour, lv_color_t foregroundColour, lv_font_t* timeFont) {
  ...
  lv_obj_set_style_local_text_color(hourValue, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, foregroundColour);
  ...
  lv_obj_set_style_local_text_color(minuteValue, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, foregroundColour);
